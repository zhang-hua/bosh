module Bosh::Director
  module Jobs
    class UpdateDeployment < BaseJob
      ...
      def prepare
        prepare_step = DeploymentPlan::PrepareStep.new(self, assembler)
        prepare_step.perform
      end

      def compile
        compile_step = PackageCompileStep.new(self, deployment_plan)
      ...
      def update
        ...
        update_step = DeploymentPlan::UpdateStep.new(self, event_log, resource_pools, assembler, deployment_plan, deployment_plan.model, multi_job_updater)
        update_step.perform
      end
      ...
      def deployment_plan
        @deployment_plan ||= begin
          ...
          plan = DeploymentPlan::Plan.from_manifest(deployment_manifest, plan_options)
