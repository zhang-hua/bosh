module Bosh::Director
  module Api
    class DeploymentManager
      ...
      def create_deployment(username, deployment_manifest, iaas_config, options = {})
        ...
        iaas_config_id = iaas_config.nil? ? nil : iaas_config.id
        JobQueue.new.enqueue(username, Jobs::UpdateDeployment, 'create deployment', [deployment_manifest_file, iaas_config_id, options])
      end
