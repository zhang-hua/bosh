...
module VSphereCloud
  describe Cloud do
    ...
    describe '#create_vm' do
      ...
      context 'delegating to the VmCreator class to create the VM' do
          ...
          let(:creator_class) { class_double('VSphereCloud::VmCreator').as_stubbed_const }
        ...
        context 'when both disk locality and environment are omitted' do
          it 'passes disk locality and environment as nils' do
            ...
            expect(creator_class).to receive(:build).with(
